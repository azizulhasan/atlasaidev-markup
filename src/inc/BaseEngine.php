...
namespace AtlasAiDev\MarkUp\Inc;
...
abstract class BaseEngine {
    ...
    protected function read_schema( $schema_file ) {
        ...
        $schema_data = file_get_contents( MARKUP_ASSETS . '/templates/' . $schema_file );
    ...
    public function __destruct() {
        $this->update_schema();
        $schema = apply_filters("markup_{$this->schema_type}_schema", $this->schema);
        echo "<script src='markup-$this->schema_type' type='application/ld+json'>$schema</script>";
    }
}