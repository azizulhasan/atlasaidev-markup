...
class Product extends BaseEngine {
    ...
    protected function update_schema() {
        ...
        return apply_filters("markup_{$this->schema_type}_update_schema", $this->schema, $this->product);
    }
    ...
    protected function single_product( $product_arr ) {
        ...
        return apply_filters("markup_{$this->schema_type}_single_product", $product_arr, $this->product);
    }
    ...
    protected function name() {
        return apply_filters( "markup_{$this->schema_type}", $this->product->get_name(), $this->product );
    }
    ...
    protected function description() {
        return apply_filters( "markup_{$this->schema_type}", $this->product->get_description(), $this->product );
    }
    ...
    protected function review( $review ) {
        ...
        if ( ! empty( $review_arr ) ) {
            ...
            return apply_filters( "markup_{$this->schema_type}_review", $review_data, $this->product );
        }
    ...
    protected function review_reviewRating( $reviewRating, $commentId ) {
        ...
        if ( ! empty( $reviewRating['ratingValue'] ) ) {
            return apply_filters( "markup_{$this->schema_type}_review_reviewRating", $reviewRating, $this->product );
        }
        return [];
    }
    ...
    protected function aggregateRating( $aggregateRating ) {
        ...
        if ( !empty( $aggregateRating['ratingValue'] ) && !empty( $aggregateRating['reviewCount'] ) ) {
            return apply_filters( "markup_{$this->schema_type}_aggregateRating", $aggregateRating, $this->product );
        }
    ...
    protected function image( $images = [] ) {
        ...
        return apply_filters("markup_{$this->schema_type}_image", $images, $this->product);
    }
    ...
    protected function brand( $brand ) {
        ...
        if ( ! empty ( $brand['name'] ) ) {
            return apply_filters("markup_{$this->schema_type}_brand", $brand, $this->product);
        }
        return [];
    }
    ...
    protected function offers_depth()
    {
        ...
        if ( ! empty( $depth['value'] ) ) {
            return apply_filters( "markup_{$this->schema_type}_offers_depth", $depth, $this->product );
        }
    ...
    protected function offers_width()
    {
        ...
        if ( ! empty( $width['value'] ) ) {
            return apply_filters( "markup_{$this->schema_type}_offers_width", $width, $this->product );
        }
    ...
    protected function offers_height() {
        ...
        if ( ! empty( $height['value'] ) ) {
            return apply_filters( "markup_{$this->schema_type}_offers_width", $height, $this->product );
        }
