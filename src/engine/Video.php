...
namespace AtlasAiDev\MarkUp\Engine;
...
class Video extends BaseEngine {
    ...
    protected function single_video( $video_arr ) {
        ...
        return apply_filters("markup_{$this->schema_type}_single_video", $video_arr );
    }
    ...
    protected function name() {
        ...
        if ( ! empty( $name ) ) {
            return apply_filters("markup_{$this->schema_type}_name", $name );
        }
    }
    ...
    protected function description() {
        ...
        if (!empty($description)) {
            return apply_filters("markup_{$this->schema_type}_description", $description);
        }
    }
...
//        error_log( print_r( $this->video_links, true ) );
    ...
    protected function uploadDate() {
        ...
        if (!empty($uploadDate)) {
            return apply_filters("markup_{$this->schema_type}_uploadDate", $uploadDate);
        }
    }
    ...
    protected function duration() {
        ...
        if (!empty($duration)) {
            return apply_filters("markup_{$this->schema_type}_duration", $duration);
        }
    }
    ...
    protected function contentUrl() {
        ...
        if ( ! empty( $contentUrl ) ) {
            return apply_filters("markup_{$this->schema_type}_contentUrl", $contentUrl);
        }
    ...
    protected function regionsAllowed() {
        ...
        if (!empty($regionsAllowed)) {
            return apply_filters("markup_{$this->schema_type}_regionsAllowed", $regionsAllowed);
        }
    }
    ...
    protected function interactionCount() {
        ...
        if (!empty($interactionCount)) {
            return apply_filters("markup_{$this->schema_type}_interactionCount", $interactionCount);
        }
    }
    ...
    protected function dateModified() {
        ...
        if ( ! empty( $date_modified ) ) {
            return apply_filters("markup_{$this->schema_type}_dateModified", $date_modified);
        }
        return null;
    }
    ...
    protected function datePublished() {
        ...
        if (!empty($date_published)) {
            return apply_filters("markup_{$this->schema_type}_datePublished", $date_published);
        }
        return null;
    }
    ...
    protected function videoQuality() {
        ...
        if (!empty($videoQuality)) {
            return apply_filters("markup_{$this->schema_type}_videoQuality", $videoQuality);
        }
    }
    ...
    protected function transcript() {
        ...
        if (!empty($transcript)) {
            return apply_filters("markup_{$this->schema_type}_transcript", $transcript);
        }
    }
    ...
    protected function genre() {
        ...
        if (!empty($genre)) {
            return apply_filters("markup_{$this->schema_type}_genre", $genre);
        }
    }
    ...
    protected function isFamilyFriendly() {
        ...
        if (!empty($isFamilyFriendly)) {
            return apply_filters("markup_{$this->schema_type}_isFamilyFriendly", $isFamilyFriendly);
        }
    }
    ...
    protected function requiresSubscription() {
        ...
        if (!empty($requiresSubscription)) {
            return apply_filters("markup_{$this->schema_type}_requiresSubscription", $requiresSubscription);
        }
    }
    ...
    protected function license() {
        ...
        if (!empty($license)) {
            return apply_filters("markup_{$this->schema_type}_license", $license);
        }
    }
