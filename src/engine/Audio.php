...
//            $mainEntityOfPage = $this->mainEntityOfPage();
        ...
        return apply_filters("markup_{$this->schema_type}_single_audio", $audio_arr );
    }
    ...
    protected function contentUrl() {
        ...
        return !empty( $contentUrl ) ? apply_filters("markup_{$this->schema_type}_contentUrl", $contentUrl) : null;
    }
    ...
    protected function additionalContentUrls() {
        ...
        return !empty( $additionalContentUrls ) ? apply_filters("markup_{$this->schema_type}_additionalContentUrls", $additionalContentUrls) : null;
    }
